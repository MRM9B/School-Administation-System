      ...
      <div class="row">
        <div class="col-md-2">
          <div class="list-group">
            ...
            <a href="semestre1class1.php" class="list-group-item list-group-item-action" style="color: #131339;background-color: #b7bbc9; font-weight: bold;">Niveau 1</a>
            ...
            <a href="semestre1class6.php" class="list-group-item list-group-item-action" style="color: #131339;font-weight: bold;">Niveau 6</a>
          </div>
        </div>
        <div class="col-md-9">
