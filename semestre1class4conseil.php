...
<html lang="en">
  <head>
    ...
    <title>Conseil départemental du niveau 4</title>
      ...
      <div class="row">
        <div class="col-md-2">
          <div class="list-group">
            ...
            <a href="semestre1class4conseil.php" class="list-group-item list-group-item-action" style="color: #131339;font-weight: bold;background-color: #b7bbc9;">Niveau 4</a>
