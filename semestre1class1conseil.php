...
<html lang="en">
  <head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    <title>Conseil départemental du niveau 1</title>
      ...
      <div class="row">
        <div class="col-md-2">
          <div class="list-group">
            ...
            <a href="semestre1class1conseil.php" class="list-group-item list-group-item-action" style="color: #131339;font-weight: bold;background-color: #b7bbc9;">Niveau 1</a>
