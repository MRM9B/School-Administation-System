...
<html lang="en">
  <head>
    ...
    <title>Etudiants en niveau 1</title>
    <!-- Bootstrap CSS -->
      ...
      <div class="row">
        <div class="col-md-2">
          <div class="list-group">
            ...
            <a href="#" class="list-group-item list-group-item-action active" style="text-align: center;font-weight: bold;background:#131339;border-color: #131339;">Niveaux</a>
            <a href="semestre2class1.php" class="list-group-item list-group-item-action" style="color: #131339; font-weight: bold;">Niveau 1</a>
            <a href="semestre2class2.php" class="list-group-item list-group-item-action" style="color: #131339;font-weight: bold;">Niveau 2</a>
            <a href="semestre2class3.php" class="list-group-item list-group-item-action" style="color: #131339;font-weight: bold;">Niveau 3</a>
            <a href="semestre2class4.php" class="list-group-item list-group-item-action" style="color: #131339;font-weight: bold;">Niveau 4</a>
            <a href="semestre2class5.php" class="list-group-item list-group-item-action" style="color: #131339;font-weight: bold;">Niveau 5</a>
            <a href="semestre2class6.php" class="list-group-item list-group-item-action" style="color: #131339;font-weight: bold;background-color: #b7bbc9;">Niveau 6</a>
          </div>
        </div>
        <div class="col-md-9">
