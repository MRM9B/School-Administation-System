<?php
  ...
  $displayquery4 = "SELECT COUNT(*) AS `feminin` FROM `note_c3` where genre='Féminin' "; 
  $displayquery5 = "SELECT COUNT(*) AS `masculin` FROM `note_c3` where genre='Masculin' "; 
  ...
  $displayquery44 = "SELECT COUNT(*) AS `count4` FROM `note_c3` where decision='Alerte' "; 
  ...
  $displayquery6 = "SELECT COUNT(*) AS `count6` FROM `note_c3` where moyenne>=0 and moyenne<5";
  $displayquery7 = "SELECT COUNT(*) AS `count7` FROM `note_c3` where moyenne>=5 and moyenne<7";  
  $displayquery8 = "SELECT COUNT(*) AS `count8` FROM `note_c3` where moyenne>=7 and moyenne<10";
      ...
      <div class="row">
        <div class="col-md-2">
          <div class="list-group">
            ...
            <a href="semestre1stats3.php" class="list-group-item list-group-item-action" style="color: #131339;font-weight: bold;background-color: #b7bbc9;">Niveau 3</a>
