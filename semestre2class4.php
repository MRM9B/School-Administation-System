      ...
      <div class="row">
        <div class="col-md-2">
          <div class="list-group">
            ...
            <a href="semestre2class4.php" class="list-group-item list-group-item-action" style="color: #131339;font-weight: bold;background-color: #b7bbc9;">Niveau 4</a>
            <a href="semestre2class5.php" class="list-group-item list-group-item-action" style="color: #131339;font-weight: bold;">Niveau 5</a>
            <a href="semestre2class6.php" class="list-group-item list-group-item-action" style="color: #131339;font-weight: bold;">Niveau 6</a>
          </div>
        </div>
        <div class="col-md-9">
