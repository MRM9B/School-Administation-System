...
if(isset($_POST['readrecord5'])){
	...
	//----------------------------------------c1-------------------------------------------
	$displayquery = "SELECT COUNT(*) AS `mas1` FROM `note_c1` where genre='Masculin'";
	$displayquery1 = "SELECT COUNT(*) AS `fem1` FROM `note_c1` where genre='Féminin'";
	$displayquery2 = "SELECT COUNT(*) AS `tot1` FROM `note_c1`";

	$displayquery3 = "SELECT COUNT(*) AS `hasmoy1` FROM `note_c1` where moyenne>=5";
	$displayquery4 = "SELECT COUNT(*) AS `hasnmoy1` FROM `note_c1` where moyenne<5";

	$displayquery5 = "SELECT MAX(moyenne) AS `max1` FROM `note_c1`"; 
	$displayquery6 = "SELECT MIN(moyenne) AS `min1` FROM `note_c1`";

	$displayquery7 = "SELECT round((SUM(moyenne)/COUNT(*)),2) AS `sum1` FROM `note_c1`";

	$displayquery8 = "SELECT COUNT(*) AS `count11` FROM `note_c1` where moyenne>=0 and moyenne<5";
	$displayquery9 = "SELECT COUNT(*) AS `count12` FROM `note_c1` where moyenne>=5 and moyenne<7";
	$displayquery10 = "SELECT COUNT(*) AS `count13` FROM `note_c1` where moyenne>=7 and moyenne<9";
	$displayquery11 = "SELECT COUNT(*) AS `count14` FROM `note_c1` where moyenne>=9";

//----------------------------------------c2-------------------------------------------
	$displayquer = "SELECT COUNT(*) AS `mas1` FROM `note_c2` where genre='Masculin'";
	$displayquery12 = "SELECT COUNT(*) AS `fem1` FROM `note_c2` where genre='Féminin'";
	$displayquery22 = "SELECT COUNT(*) AS `tot1` FROM `note_c2`";

	$displayquery32 = "SELECT COUNT(*) AS `hasmoy1` FROM `note_c2` where moyenne>=5";
	$displayquery42 = "SELECT COUNT(*) AS `hasnmoy1` FROM `note_c2` where moyenne<5";

	$displayquery52 = "SELECT MAX(moyenne) AS `max1` FROM `note_c2`"; 
	$displayquery62 = "SELECT MIN(moyenne) AS `min1` FROM `note_c2`";

	$displayquery72 = "SELECT round((SUM(moyenne)/COUNT(*)),2) AS `sum1` FROM `note_c2`";

	$displayquery82 = "SELECT COUNT(*) AS `count11` FROM `note_c2` where moyenne>=0 and moyenne<5";
	$displayquery92 = "SELECT COUNT(*) AS `count12` FROM `note_c2` where moyenne>=5 and moyenne<7";
	$displayquery102 = "SELECT COUNT(*) AS `count13` FROM `note_c2` where moyenne>=7 and moyenne<9";
	$displayquery112 = "SELECT COUNT(*) AS `count14` FROM `note_c2` where moyenne>=9";
...
//----------------------------------------c3-------------------------------------------
	$displayqueryc3 = "SELECT COUNT(*) AS `mas1` FROM `note_c3` where genre='Masculin'";
	$displayqueryc31 = "SELECT COUNT(*) AS `fem1` FROM `note_c3` where genre='Féminin'";
	$displayqueryc32 = "SELECT COUNT(*) AS `tot1` FROM `note_c3`";

	$displayqueryc33 = "SELECT COUNT(*) AS `hasmoy1` FROM `note_c3` where moyenne>=5";
	$displayqueryc34 = "SELECT COUNT(*) AS `hasnmoy1` FROM `note_c3` where moyenne<5";

	$displayqueryc35 = "SELECT MAX(moyenne) AS `max1` FROM `note_c3`"; 
	$displayqueryc36 = "SELECT MIN(moyenne) AS `min1` FROM `note_c3`";

	$displayqueryc37 = "SELECT round((SUM(moyenne)/COUNT(*)),2) AS `sum1` FROM `note_c3`";

	$displayqueryc38 = "SELECT COUNT(*) AS `count11` FROM `note_c3` where moyenne>=0 and moyenne<5";
	$displayqueryc39 = "SELECT COUNT(*) AS `count12` FROM `note_c3` where moyenne>=5 and moyenne<7";
	$displayqueryc310 = "SELECT COUNT(*) AS `count13` FROM `note_c3` where moyenne>=7 and moyenne<9";
	$displayqueryc311 = "SELECT COUNT(*) AS `count14` FROM `note_c3` where moyenne>=9";
	...
	$resultc311 = mysqli_query($conn,$displayqueryc311);
		...
		//----------------------------------------c4-------------------------------------------
	$displayqueryc4 = "SELECT COUNT(*) AS `mas1` FROM `note_c4` where genre='Masculin'";
	$displayqueryc41 = "SELECT COUNT(*) AS `fem1` FROM `note_c4` where genre='Féminin'";
	$displayqueryc42 = "SELECT COUNT(*) AS `tot1` FROM `note_c4`";

	$displayqueryc43 = "SELECT COUNT(*) AS `hasmoy1` FROM `note_c4` where moyenne>=5";
	$displayqueryc44 = "SELECT COUNT(*) AS `hasnmoy1` FROM `note_c4` where moyenne<5";

	$displayqueryc45 = "SELECT MAX(moyenne) AS `max1` FROM `note_c4`"; 
	$displayqueryc46 = "SELECT MIN(moyenne) AS `min1` FROM `note_c4`";

	$displayqueryc47 = "SELECT round((SUM(moyenne)/COUNT(*)),2) AS `sum1` FROM `note_c4`";

	$displayqueryc48 = "SELECT COUNT(*) AS `count11` FROM `note_c4` where moyenne>=0 and moyenne<5";
	$displayqueryc49 = "SELECT COUNT(*) AS `count12` FROM `note_c4` where moyenne>=5 and moyenne<7";
	$displayqueryc410 = "SELECT COUNT(*) AS `count13` FROM `note_c4` where moyenne>=7 and moyenne<9";
	$displayqueryc411 = "SELECT COUNT(*) AS `count14` FROM `note_c4` where moyenne>=9";
	...
	$resultc411 = mysqli_query($conn,$displayqueryc411);
		...
		$rowc411 = mysqli_fetch_assoc($resultc411);
			...
			//----------------------------------------c5-------------------------------------------
	$displayqueryc5 = "SELECT COUNT(*) AS `mas1` FROM `note_c5` where genre='Masculin'";
	$displayqueryc51 = "SELECT COUNT(*) AS `fem1` FROM `note_c5` where genre='Féminin'";
	$displayqueryc52 = "SELECT COUNT(*) AS `tot1` FROM `note_c5`";

	$displayqueryc53 = "SELECT COUNT(*) AS `hasmoy1` FROM `note_c5` where moyenne>=5";
	$displayqueryc54 = "SELECT COUNT(*) AS `hasnmoy1` FROM `note_c5` where moyenne<5";

	$displayqueryc55 = "SELECT MAX(moyenne) AS `max1` FROM `note_c5`"; 
	$displayqueryc56 = "SELECT MIN(moyenne) AS `min1` FROM `note_c5`";

	$displayqueryc57 = "SELECT round((SUM(moyenne)/COUNT(*)),2) AS `sum1` FROM `note_c5`";

	$displayqueryc58 = "SELECT COUNT(*) AS `count11` FROM `note_c5` where moyenne>=0 and moyenne<5";
	$displayqueryc59 = "SELECT COUNT(*) AS `count12` FROM `note_c5` where moyenne>=5 and moyenne<7";
	$displayqueryc510 = "SELECT COUNT(*) AS `count13` FROM `note_c5` where moyenne>=7 and moyenne<9";
	$displayqueryc511 = "SELECT COUNT(*) AS `count14` FROM `note_c5` where moyenne>=9";
	...
	$resultc511 = mysqli_query($conn,$displayqueryc511);
		...
		//----------------------------------------c6-------------------------------------------
	$displayqueryc6 = "SELECT COUNT(*) AS `mas1` FROM `note_c6` where genre='Masculin'";
	$displayqueryc61 = "SELECT COUNT(*) AS `fem1` FROM `note_c6` where genre='Féminin'";
	$displayqueryc62 = "SELECT COUNT(*) AS `tot1` FROM `note_c6`";

	$displayqueryc63 = "SELECT COUNT(*) AS `hasmoy1` FROM `note_c6` where moyenne>=5";
	$displayqueryc64 = "SELECT COUNT(*) AS `hasnmoy1` FROM `note_c6` where moyenne<5";

	$displayqueryc65 = "SELECT MAX(moyenne) AS `max1` FROM `note_c6`"; 
	$displayqueryc66 = "SELECT MIN(moyenne) AS `min1` FROM `note_c6`";

	$displayqueryc67 = "SELECT round((SUM(moyenne)/COUNT(*)),2) AS `sum1` FROM `note_c6`";

	$displayqueryc68 = "SELECT COUNT(*) AS `count11` FROM `note_c6` where moyenne>=0 and moyenne<5";
	$displayqueryc69 = "SELECT COUNT(*) AS `count12` FROM `note_c6` where moyenne>=5 and moyenne<7";
	$displayqueryc610 = "SELECT COUNT(*) AS `count13` FROM `note_c6` where moyenne>=7 and moyenne<9";
	$displayqueryc611 = "SELECT COUNT(*) AS `count14` FROM `note_c6` where moyenne>=9";
