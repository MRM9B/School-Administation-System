...
<html lang="en">
  <head>
    ...
    <title>Conseil départemental du niveau 3</title>
      ...
      <div class="row">
        <div class="col-md-2">
          <div class="list-group">
            ...
            <a href="#" class="list-group-item list-group-item-action" style="color: #131339;font-weight: bold;"><a href="semestre1class1conseil.php" class="list-group-item list-group-item-action" style="color: #131339;font-weight: bold">Niveau 1</a>
            <a href="semestre1class2conseil.php" class="list-group-item list-group-item-action" style="color: #131339;font-weight: bold;">Niveau 2</a>
            <a href="semestre1class3conseil.php" class="list-group-item list-group-item-action" style="color: #131339;font-weight: bold;background-color: #b7bbc9;">Niveau 3</a>
